      ...
      <div class="modal-wrapper">
        <div class="modal-container">
          ...
          <div class="modal-footer">
            <slot name="footer">
                <a class="txt_blue font-bold darken-2" flat="flat" @click="backToSrp">Back To Search</a>
                <a class="txt_blue font-bold darken-2 fr" flat="flat" @click="closeDialog">Close</a>
            </slot>
          </div>
        </div>          
      </div>
  ...
  import router from '../../router'
   export default {
     ...
     methods: {
       ...
       closeDialog() {
        this.dialog = false;
        this.$emit('closePaymentError', false);           
       }
     },
     created() {
        this.dialog = this.showPaymentDialog;
