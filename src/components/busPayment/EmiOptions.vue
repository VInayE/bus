<template>
     <v-dialog v-model="emiDialog" fullscreen transition="dialog-bottom-transition" :overlay="false">
      <v-toolbar dark class="red">
        ...
        <select-emi-tenure :openSelectEmiTenureDialog="openSelectEmiTenureDialog"                                                            @closeSelectEmiTenureDialog="openSelectEmiTenureDialog = false"                                                  :selectedEmiTenure="selectedEmiTenure"
